...
function armor_t0:OnCreated() self.v = 3 end
function armor_t1:OnCreated() self.v = 6 end
function armor_t2:OnCreated() self.v = 12 end
function armor_t3:OnCreated() self.v = 24 end
